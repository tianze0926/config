...
{ inputs, lib, ... }: {
  ...
  programs.plasma = import ./recMap.nix lib.mkDefault {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-b4e4e166-22cb-49d0-b2d7-50bc91d6adb0" = [ ];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."b4e4e166-22cb-49d0-b2d7-50bc91d6adb0" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "b4e4e166-22cb-49d0-b2d7-50bc91d6adb0";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{322cd5dd-b8ae-488e-87df-fb0fd1ea5da8}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{d337f87b-be8c-4e2d-9ea2-984ab81f9393}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{529085ad-f292-4d23-ae4f-71d49259ede3}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{21762f67-160d-4503-b806-add4efcafa37}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{405e5feb-a8d9-46dc-a675-e9964035ab17}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{c1167f38-316b-4afb-9427-f03c2a1f7966}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{87067ee9-8d04-4132-8afa-22f21fe7c031}";
      ...
      "kwinrc"."Desktops"."Id_1" = "19f4be42-762a-4fb8-b7b5-9431b5ea6d6e";
      ...
      "kwinrc"."Tiling.bac94253-69b3-5ca8-8ddd-eac451a2ffab"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
